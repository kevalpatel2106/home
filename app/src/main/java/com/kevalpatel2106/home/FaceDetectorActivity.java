    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
                    List<VisionDetRet> recognitions = new FaceDet(Constants.getFaceShapeModelPath()).detect(bitmap);

                    if (recognitions != null) {
                        String reslut = "Total faces : " + recognitions.size() + "\n";
                        for (VisionDetRet recognition : recognitions) {
                            Log.d("Face", recognition.getLabel() + " " + recognition.getLeft() + " " + recognition.getRight());
                            reslut = reslut + recognition.getLabel() + " > " + recognition.getConfidence() + "\n";
                        }
