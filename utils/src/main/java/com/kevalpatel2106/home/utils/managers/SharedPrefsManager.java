 ...
 * Class contains all the helper functions to access shared prefs. You can have all the keys for
 * the shared preference in {@link Keys}.
 *
...
public final class SharedPrefsManager {
    ...
    /**
     * All the keys for the shared preference entry.
     */
    public static class Keys {
        //Key to store bool that indicates if the device is registered?
